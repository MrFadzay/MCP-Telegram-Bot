...
class Message(Base):
    ...
    # Message content
    message_type: Mapped[str] = mapped_column(String(20))  # 'user', 'assistant', 'system', 'tool_call', 'tool_result'
    role: Mapped[str] = mapped_column(String(20))  # For OpenAI API compatibility: 'user', 'assistant', 'system'
    content: Mapped[str] = mapped_column(Text)
    
    # Metadata
    message_metadata: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)  # Model, tokens, execution time, MCP tools used
