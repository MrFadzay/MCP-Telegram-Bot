            ...
            try:
                ...
                if provider == "google" and "gemini-2.5" in model:
                    ...
                    try:
                        ...
                        response = await self.llm_selector.generate_response(prompt)
                        await update.message.reply_text(response)
                ...
                if file_ext in ['.txt', '.md', '.py', '.js', '.html', '.css', '.json']:
                    ...
                    try:
                        ...
                        with open(file_path, 'rb') as file:
                            ...
                            for page_num in range(min(num_pages, 20)):  # Ограничиваем 20 страницами
                        ...
                        if len(pdf_text) > 8000:
                            ...
                            chunks = [pdf_text[i:i+8000] for i in range(0, len(pdf_text), 8000)]
